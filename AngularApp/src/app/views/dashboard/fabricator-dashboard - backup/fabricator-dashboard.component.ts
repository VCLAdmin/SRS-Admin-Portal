...
//   getItems() {
//     this.getItemSub = this.getItemsForOrderDashboard()
//       .subscribe(data => {
//         
...
//   getItemsForOrderDashboard(): Observable<number[]> {
//     // return  of(this.items.slice())
//     let url: string = this.appConstantService.APP_DOMAIN + "api/Order/GetOrderDashboard/Count";
