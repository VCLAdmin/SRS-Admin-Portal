...
import { FabricatorDashboardComponent } from './fabricator-dashboard/fabricator-dashboard.component';
...
export const DashboardRoutes: Routes = [
  ...
  {
    path: 'fabricator',
    component: FabricatorDashboardComponent,
    canActivate: [FabricatorRoleGuard],
    data: { title: 'Dashboard', breadcrumb: 'Fabricator', roles: config.authRoles.sa }
  },
  {
