...
export interface ILayoutConf {
  ...
  matTheme?: string; // material theme. egret-blue, schuco-green, egret-dark-purple, egret-dark-pink
...
export class LayoutService {
  ...
  constructor(private themeService: ThemeService) {
    ...
    //     matTheme: 'schuco-green', // egret-blue, schuco-green, egret-light-purple, egret-dark-purple, egret-dark-pink
