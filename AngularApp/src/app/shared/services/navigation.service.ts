  ...
  publishNavigationChange(menuType: string) {
    ...
    switch (menuType) {
      ...
      case 'icon-menu':
        ...
        break;
      case 'icon-menu-fabricator': //'icon-menu-fabricator':
        this.menuItems.next(this.iconMenuFabricator);
        break;
      default:
